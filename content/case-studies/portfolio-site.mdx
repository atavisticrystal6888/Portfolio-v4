...
<Gallery>
  <Shot src="/images/projects/portfolio-site/home.png" alt="Portfolio home page showing the hero section and product-focused positioning." caption="Home: headline, positioning, and CTA structure are optimised for recruiter skim in the first screenful." />
  <Shot src="/images/projects/portfolio-site/projects.png" alt="Portfolio projects page showing filter controls and screenshot-backed project cards." caption="Projects: the portfolio now behaves like a proof library, with screenshot-backed cards and case-study navigation." />
  <Shot src="/images/projects/portfolio-site/about.png" alt="Portfolio about page: the headshot beside the story, ending on the education line." caption="About: narrative depth and the real headshot reinforce credibility without sacrificing the product lens." />
</Gallery>
