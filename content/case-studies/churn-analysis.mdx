...
role: "Data Analyst"
myPart: "The analysis end to end — data preparation, the predictive model, and the retention readout."
duration: "2024"
...
metrics:
  ...
  - label: "Data Sources"
    ...
    displayValue: "3"
    chartType: "bar"
prevSlug: "better-half"
nextSlug: "tcs-nqt-prep-hub"
---

## Context & Problem

> Source: [Customer-churn-analysis](https://github.com/atavisticrystal6888/Customer-churn-analysis)

For an early-stage SaaS product, churn was rising with no clear visibility into why customers were leaving. Revenue was being lost, but the root causes were buried in fragmented data across billing, support, and usage systems.
...
- **Source:** [github.com/atavisticrystal6888/Customer-churn-analysis](https://github.com/atavisticrystal6888/Customer-churn-analysis)
