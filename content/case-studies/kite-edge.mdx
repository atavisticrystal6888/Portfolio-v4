...
<!-- v5 WS-C reserved slot: QuantStats tear sheet from demo input + product
     photos land here as a <figure class="case-artifact"> when supplied.
     Constraints in handover-portfolio-round2.md §KiteEdge apply: demo data
     only, never the credentialed services. -->
