...
excerpt: "Someone says “we need to improve the user experience” and the room nods along. That is unstructured ambiguity, and it is the raw material of the job. The four steps I put it through."
socialImage: null
---
...
But most PMs don't have a repeatable system for this. They rely on experience, pattern matching, and (secretly) hoping someone else in the room will add structure. Across a year of PM internships and my own side projects — from shipping lead-management flows at Omniful to building analytics frameworks of my own — I've developed a 4-step framework that works reliably.
...
Here's how I applied this at a SaaS product when faced with "we're losing too many users":
...
Having used this framework across every internship and side project since, here are the mistakes I see (and sometimes still make):
